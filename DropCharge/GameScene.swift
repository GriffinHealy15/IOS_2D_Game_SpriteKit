...
//  DropCharge
//
//  Created by Griffin Healy on 8/4/18.
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    timeSinceLastExplosion += dt
        //print("timesincelastexplosion:  \(timeSinceLastExplosion)")
        //print("timeforenextexplosion:  \(timeForNextExplosion)")
